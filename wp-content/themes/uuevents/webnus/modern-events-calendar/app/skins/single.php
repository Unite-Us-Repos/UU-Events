...
class MEC_skin_single extends MEC_skins
{
     ...
     */
    // UU Mofication
    // Use $raw parameter to determine if the event is raw or not
    // Used on event single view
    public function display_related_posts_widget($event, $thumbnail_size = 'thumblist', $raw = false)
    {
        ...
        // UU Modification
        // If the event is raw, we don't need to display the html, just return the query
        if ($raw) {
            return $query;
        }
        // UU HACK Modification
