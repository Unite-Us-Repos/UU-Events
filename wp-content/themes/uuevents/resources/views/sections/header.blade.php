<div class="relative shadow-sm top-nav bg-white z-40" x-data="Components.popover({ open: false, focus: true })" x-init="init()" @keydown.escape="onEscape" @close-popover-group.window="onClosePopoverGroup">
  <div class="mx-autao">
    <div class="flex justify-between items-center max-w-7xl mx-auto px-8 lg:justify-start md:space-x-10">
      <div class="flex justify-start py-4 lg:w-0 lg:flex-1">
        <a href="/">
          ...
          <img src="https://uniteus.com/wp-content/themes/uniteus-sage/public/images/unite-us-logo.svg" alt="Unite Us">
        </a>
      </div>
  ...
  <!-- Modal -->
  <div class="fixed inset-0 z-30 hidden items-center justify-center overflow-auto bg-brand bg-opacity-80" :class="{ 'hidden': ! showSearchModal, 'flex': showSearchModal }" x-show="showSearchModal" style="display: none;">
    <!-- Modal inner -->
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M4.58496 0C4.85018 5.96046e-08 5.10453 0.105357 5.29207 0.292893L8.29207 3.29289C8.68259 3.68342 8.68259 4.31658 8.29207 4.70711C7.90154 5.09763 7.26838 5.09763 6.87785 4.70711L4.58496 2.41421L2.29207 4.70711C1.90154 5.09763 1.26838 5.09763 0.877854 4.70711C0.48733 4.31658 0.48733 3.68342 0.877854 3.29289L3.87785 0.292893C4.06539 0.105357 4.31975 0 4.58496 0ZM0.877854 9.29289C1.26838 8.90237 1.90154 8.90237 2.29207 9.29289L4.58496 11.5858L6.87785 9.29289C7.26838 8.90237 7.90154 8.90237 8.29207 9.29289C8.68259 9.68342 8.68259 10.3166 8.29207 10.7071L5.29207 13.7071C4.90154 14.0976 4.26838 14.0976 3.87785 13.7071L0.877854 10.7071C0.48733 10.3166 0.48733 9.68342 0.877854 9.29289Z" fill="#216CFF"></path>
    ...
    <ul class="">
            <li class="sf-level-0 sf-item-0 sf-option-active" data-sf-depth="0"><input class="sf-input-radio" type="radio" value="" name="_sf_post_type[]" checked="checked" id="sf-input-d8495250594012b8adfef135ef0da4c3"><label class="sf-label-radio" for="sf-input-d8495250594012b8adfef135ef0da4c3">Search Entire Site</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="post" name="_sf_post_type[]" id="sf-input-d4551dd3bdbe98b6cb649dbbe49d9e99"><label class="sf-label-radio" for="sf-input-d4551dd3bdbe98b6cb649dbbe49d9e99">Posts</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="page" name="_sf_post_type[]" id="sf-input-ec42afd8536f2f8f5158d05f38ecb572"><label class="sf-label-radio" for="sf-input-ec42afd8536f2f8f5158d05f38ecb572">Pages</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="team" name="_sf_post_type[]" id="sf-input-13a52a3c4283a3e7d22cbc4b72b1e4ac"><label class="sf-label-radio" for="sf-input-13a52a3c4283a3e7d22cbc4b72b1e4ac">Team</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="press" name="_sf_post_type[]" id="sf-input-f8f92d25c89bdc3c62e61c32346f6afe"><label class="sf-label-radio" for="sf-input-f8f92d25c89bdc3c62e61c32346f6afe">Press</label></li>   </ul>
</div>
    </div></li><li class="sf-field-search" data-sf-field-name="search" data-sf-field-type="search" data-sf-field-input-type="">   <label>
  ...
  #ajax-filters.search-filters ul {
    ...
    align-items: normal;
      ...
      <nav class="hidden lg:flex space-x-10">
          ...
          <a href="https://uniteus.com/solutions/" class="group bg-white rounded-md inline-flex items-center text-base font-medium py-4 hover:text-brand focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-action text-brand">
            <span>Solutions</span>
            <svg class="ml-2 h-5 w-5 group-hover:text-gray-500 text-gray-400" x-description="Heroicon name: solid/chevron-down" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <div class="absolute hidden group-focus:block group-hover:block z-20 left-1/2 transform -translate-x-1/2 mt-0 px-2 w-screen max-w-xs sm:px-0" x-ref="panel">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                ...
                                <a href="https://uniteus.com/solutions/providers/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">For Providers</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/solutions/health-plans/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">For Health Plans</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/solutions/government/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">For Government</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/solutions/nonprofits/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
        ...
        <div class="relative group">
          <a href="https://uniteus.com/products/" class="group bg-white rounded-md inline-flex items-center text-base font-medium py-4 hover:text-brand focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-action text-brand">
            <span>Products</span>
            <svg class="ml-2 h-5 w-5 group-hover:text-gray-500 text-gray-400" x-description="Heroicon name: solid/chevron-down" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
            </svg>
          ...
          <div class="absolute hidden group-focus:block group-hover:block z-20 left-1/2 transform -translate-x-1/2 mt-0 px-2 w-screen max-w-xs sm:px-0" x-ref="panel">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                ...
                                <a href="https://uniteus.com/products/platform/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Platform</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/products/insights/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Insights</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/products/payments/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Payments</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/products/care-coordination/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Care Coordination</p>
                              ...
                              <div class="relative group">
          <a href="https://uniteus.com/networks/" class="group bg-white rounded-md inline-flex items-center text-base font-medium py-4 hover:text-brand focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-action text-brand">
            <span>Networks</span>
            <svg class="ml-2 h-5 w-5 group-hover:text-gray-500 text-gray-400" x-description="Heroicon name: solid/chevron-down" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
            </svg>
          ...
          <div class="absolute hidden group-focus:block group-hover:block z-20 left-1/2 transform -translate-x-1/2 mt-0 px-2 w-screen max-w-xs sm:px-0" x-ref="panel">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                ...
                                <a href="https://uniteus.com/how-it-works/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">How It Works</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/journey-preview/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Using Unite Us</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/spread-the-word/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Spread the Word</p>
                              ...
                              <div class="relative group">
          <a href="#" class="group bg-white rounded-md inline-flex items-center text-base font-medium py-4 hover:text-brand focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-action text-brand">
            <span>Impact</span>
            <svg class="ml-2 h-5 w-5 group-hover:text-gray-500 text-gray-400" x-description="Heroicon name: solid/chevron-down" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
            </svg>
          ...
          <div class="absolute hidden group-focus:block group-hover:block z-20 left-1/2 transform -translate-x-1/2 mt-0 px-2 w-screen max-w-xs sm:px-0" x-ref="panel">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                ...
                                <a href="https://uniteus.com/press/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Newsroom</p>

                  </div>
                </a>
                                <a href="https://events.uniteus.com/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Events</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/knowledge-hub/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
          ...
          <div class="absolute hidden group-focus:block group-hover:block z-20 left-1/2 transform -translate-x-1/2 mt-0 px-2 w-screen max-w-xs sm:px-0" x-ref="panel">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                ...
                                <a href="https://uniteus.com/about-us/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">About</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/team/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Team</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/our-careers/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
                    <p class="text-base font-medium text-brand">Careers</p>

                  </div>
                </a>
                                <a href="https://uniteus.com/contact/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                  <div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M4.58496 0C4.85018 5.96046e-08 5.10453 0.105357 5.29207 0.292893L8.29207 3.29289C8.68259 3.68342 8.68259 4.31658 8.29207 4.70711C7.90154 5.09763 7.26838 5.09763 6.87785 4.70711L4.58496 2.41421L2.29207 4.70711C1.90154 5.09763 1.26838 5.09763 0.877854 4.70711C0.48733 4.31658 0.48733 3.68342 0.877854 3.29289L3.87785 0.292893C4.06539 0.105357 4.31975 0 4.58496 0ZM0.877854 9.29289C1.26838 8.90237 1.90154 8.90237 2.29207 9.29289L4.58496 11.5858L6.87785 9.29289C7.26838 8.90237 7.90154 8.90237 8.29207 9.29289C8.68259 9.68342 8.68259 10.3166 8.29207 10.7071L5.29207 13.7071C4.90154 14.0976 4.26838 14.0976 3.87785 13.7071L0.877854 10.7071C0.48733 10.3166 0.48733 9.68342 0.877854 9.29289Z" fill="#216CFF"></path>
    ...
    <ul class="">
            <li class="sf-level-0 sf-item-0 sf-option-active" data-sf-depth="0"><input class="sf-input-radio" type="radio" value="" name="_sf_post_type[]" checked="checked" id="sf-input-b394344e22417f134e7ad2f21b524b9a"><label class="sf-label-radio" for="sf-input-b394344e22417f134e7ad2f21b524b9a">Search Entire Site</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="post" name="_sf_post_type[]" id="sf-input-c142d268fa77141220a55ac058c1aef4"><label class="sf-label-radio" for="sf-input-c142d268fa77141220a55ac058c1aef4">Posts</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="page" name="_sf_post_type[]" id="sf-input-8f93c0c2e3c14f62e6b2f55753f15b5f"><label class="sf-label-radio" for="sf-input-8f93c0c2e3c14f62e6b2f55753f15b5f">Pages</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="team" name="_sf_post_type[]" id="sf-input-b2ff9490c9766c6fb24618e3bac455df"><label class="sf-label-radio" for="sf-input-b2ff9490c9766c6fb24618e3bac455df">Team</label></li><li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio" type="radio" value="press" name="_sf_post_type[]" id="sf-input-487097ba236c732004cf216f30cef70d"><label class="sf-label-radio" for="sf-input-487097ba236c732004cf216f30cef70d">Press</label></li>   </ul>
</div>
    </div></li><li class="sf-field-search" data-sf-field-name="search" data-sf-field-type="search" data-sf-field-input-type="">   <label>
           <input placeholder="Search" name="_sf_search[]" class="sf-input-text" type="text" value="" title=""></label>   </li><li class="sf-field-submit" data-sf-field-name="submit" data-sf-field-type="submit" data-sf-field-input-type=""><input type="submit" name="_sf_submit" value="Submit"></li></ul></form>
      </div>
...
@media  only screen and (min-width: 940px) {
  ...
  -->
  <div x-show="open" x-transition:enter="duration-200 ease-out" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="duration-100 ease-in" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" x-description="Mobile menu, show/hide based on mobile menu state." class="absolute z-50 top-0 inset-x-0 p-2 transition transform origin-top-right lg:hidden" x-ref="panel" @click.away="open = false" style="display: none;">
                  ...
                  <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 1 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                    <div class="overflow-hidden">
                      <div class="relative grid gap-6 rounded-lg bg-light mb-2 mt-6 px-5 py-6 sm:gap-8 sm:p-8">
                                            ...
                                            <a href="https://uniteus.com/solutions/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                        <div>
                          <p class="text-base font-medium text-brand">Solutions</p>
                        </div>
                      </a>
                  ...
                  <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 1 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                    <div class="overflow-hidden">
                      <div class="relative grid gap-6 rounded-lg bg-light mb-2 mt-6 px-5 py-6 sm:gap-8 sm:p-8">
                                            ...
                                            <a href="https://uniteus.com/products/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                        <div>
                          <p class="text-base font-medium text-brand">Products</p>
                        </div>
                      </a>
                  ...
                  <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 1 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                    <div class="overflow-hidden">
                      <div class="relative grid gap-6 rounded-lg bg-light mb-2 mt-6 px-5 py-6 sm:gap-8 sm:p-8">
                                            ...
                                            <a href="https://uniteus.com/networks/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                        <div>
                          <p class="text-base font-medium text-brand">Networks</p>
                        </div>
                      </a>
                          ...
                          <div>
                            <p class="text-base font-medium text-brand">Spread the Word</p>
                                              ...
                                              <a href="https://uniteus.com/user-resources/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                          <div>
                      ...
                      <div class="relative grid gap-6 rounded-lg bg-light mb-2 mt-6 px-5 py-6 sm:gap-8 sm:p-8">
                          ...
                          <div>
                            <p class="text-base font-medium text-brand">Knowledge Hub</p>
                                              ...
                                              <a href="https://uniteus.com/./blog/" class="-m-3 p-3 flex items-start rounded-lg hover:bg-light">
                          <div>
                            <p class="text-base font-medium text-brand">Blog</p>
                          </div>
                        </a>
