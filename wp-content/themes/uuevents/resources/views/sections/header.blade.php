...
<div id="nav" x-ref="nav" class="top-nav bg-white">
            ...
            <nav class="hidden lg:flex items-center space-x-5 xl:space-x-10 desktop-nav">
                        ...
                        <div class="menu-wrapper-inner overflow-hidden">
                            <div class="menu-item-wrapper relative grid gap-8 p-12  solutions-menu-item-wrapper ">
                                <div class="menu-item relative group  solutions-menu-item ">
                                    <a href="https://uniteus.com/industries/"
                                        class="flex -m-3 p-3 menu_click industries">
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Industries</span>
                                    </a>
                                    <div
                                        ...
                                        <div class="overflow-hidden">
                                            <div class="sub-sub-menu relative flex flex-col gap-6 pr-8 pb-8 pt-4">
                                                <a href="https://uniteus.com/industries/government/"
                                                    class="-m-3 p-3 flex items-start menu_click ">

                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Vector.svg"
                                                            alt="Government icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Government</span>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="https://uniteus.com/industries/providers/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Group.svg"
                                                            alt="Providers icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Providers</span>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="https://uniteus.com/industries/payers/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Group-28-1.svg"
                                                            alt="Payers icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Payers</span>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="https://uniteus.com/industries/community/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/NP-icon.svg"
                                                            alt="Community-Based Organizations icon"
                                                            class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Community-Based
                                                            Organizations</span>
                                                    </div>
                                                </a>
                                ...
                                <div class="menu-item relative group  solutions-menu-item ">
                                    <a href="https://uniteus.com/products/"
                                        class="flex -m-3 p-3 menu_click products">
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Products</span>
                                    </a>
                                    <div
                                        class="sub-sub-menu-wrapper absolute hidden group-focus:block group-hover:block z-50 left-0 top-8 mt-0 sm:px-0">
                                        <div class="overflow-hidden">
                                            <div class="sub-sub-menu relative flex flex-col gap-6 pr-8 pb-8 pt-4">
                                                <a href="https://uniteus.com/products/closed-loop-referral-system/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background.svg"
                                                            alt="Closed-Loop Referral System icon"
                                                            class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Closed-Loop
                                                ...
                                                <a href="https://uniteus.com/products/social-care-data/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-1.svg"
                                                            alt="Predictive Analytics icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Predictive
                                                            Analytics</span>
                                                        <div class="description text-xs text-gray-500 mt-2">
                                                ...
                                                <a href="https://uniteus.com/products/social-care-revenue-cycle-management/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-2.svg"
                                                            alt="Social Care Revenue Cycle Management icon"
                                                            class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Social
                                                            Care Revenue Cycle Management</span>
                                                        <div class="description text-xs text-gray-500 mt-2">
                                                ...
                                                <a href="https://uniteus.com/products/resource-directory/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-3.svg"
                                                            alt="Resource Directory icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Resource
                                                            Directory</span>
                                                        <div class="description text-xs text-gray-500 mt-2">
                                                ...
                                                <a href="https://uniteus.com/products/care-coordination-services/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-4.svg"
                                                            alt="Care Coordination icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Care
                                                            Coordination</span>
                                                        <div class="description text-xs text-gray-500 mt-2">
                                                ...
                                                <a href="https://uniteus.com/products/professional-services/"
                                                    ...
                                                    <div class="sub-sub-icon mr-2">
                                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-5.svg"
                                                            alt="Managed Services icon" class="w-5 h-5 mr-2" />
                                                    </div>
                                                    <div class="sub-sub-item">
                                                        <span
                                                            class="text-base font-bold text-brand hover:text-action">Managed
                                                            Services</span>
                                                        <div class="description text-xs text-gray-500 mt-2">
                        ...
                        <div class="menu-wrapper-inner overflow-hidden">
                            <div class="menu-item-wrapper relative grid gap-8 p-12 ">
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/industries/government/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Government</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/industries/providers/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Providers</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/industries/payers/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Payers</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/industries/community/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Community-Based
                                            Organizations</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="menu-wrapper-inner overflow-hidden">
                            <div class="menu-item-wrapper relative grid gap-8 p-12 ">
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/products/closed-loop-referral-system/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span class="text-base font-semibold text-brand hover:text-action">Closed-Loop
                                            Referral System</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/products/social-care-data/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span class="text-base font-semibold text-brand hover:text-action">Predictive
                                            Analytics</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/products/social-care-revenue-cycle-management/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span class="text-base font-semibold text-brand hover:text-action">Social Care
                                ...
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/products/resource-directory/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span class="text-base font-semibold text-brand hover:text-action">Resource
                                            Directory</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/products/care-coordination-services/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span class="text-base font-semibold text-brand hover:text-action">Care
                                            Coordination</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/products/professional-services/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <span class="text-base font-semibold text-brand hover:text-action">Managed
                                            Services</span>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="relative group flex resources ">
                    ...
                    <div
                            ...
                            <div class="menu-item-wrapper relative grid gap-8 p-12 ">
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/blog" class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-6.svg"
                                            alt="Blogs icon" class="w-8 h-8 mr-2" />
                                ...
                                <div class="menu-item relative group ">
                                    <a href="https://events.uniteus.com" class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-7.svg"
                                            alt="Events icon" class="w-8 h-8 mr-2" />
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Events</span>
                                        <div class="description text-sm text-gray-500 mt-2">
                                ...
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/report" class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-8.svg"
                                            alt="Reports icon" class="w-8 h-8 mr-2" />
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Reports</span>
                                        <div class="description text-sm text-gray-500 mt-2">
                                ...
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/webinar" class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-9.svg"
                                            alt="Videos icon" class="w-8 h-8 mr-2" />
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Videos</span>
                                        <div class="description text-sm text-gray-500 mt-2">
                                ...
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/press" class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-10.svg"
                                            alt="Newsroom icon" class="w-8 h-8 mr-2" />
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Newsroom</span>
                                        <div class="description text-sm text-gray-500 mt-2">
                                ...
                                <p class="text-base flex">
                                    <a href="https://uniteus.com/knowledge-hub/"
                                        ...
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                                            ...
                                            <path d="M8.26562 1.19189L14.0739 7.00013L8.26562 12.8084" stroke="#216CFF"
                        ...
                        <div class="featured-block relative bg-cover bg-center p-4 px-8"
                            style="background-image: url('https://uniteus.com/wp-content/uploads/2025/01/medicaid-advantage-menu-4.png');">
                            <div class="wrapper relative z-10 flex flex-col items-start">
                                <div class="pill p-1 rounded-full flex items-center gap-2">
                                    <span
                                        class="tracking-2px bg-dark text-white px-2 py-1 rounded-full uppercase font-semibold">Webinar</span>
                                    <span class="text-white flex items-center pr-4 gap-2">Featured Event <svg
                                            width="15" height="12" viewBox="0 0 15 12" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M8.8331 1.04004L13.6695 5.87642M13.6695 5.87642L8.8331 10.7128M13.6695 5.87642L0.772461 5.87642"
                                                stroke="white" stroke-width="0.905178" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    </span>
                                </div>
                                <a href="https://uniteus.com/webinar/medicare-advantage-uncovered/"
                                    class=" menu-arrow btn bg-white text-dark font-semibold rounded-md">
                                    Watch Now <svg width="12" height="9" viewBox="0 0 12 9" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M7.43219 0.887695L11.0747 4.53021M11.0747 4.53021L7.43219 8.17273M11.0747 4.53021L1.36133 4.53021"
                                            stroke="#2C405A" stroke-opacity="0.5" stroke-width="1.25793"
                            ...
                            <div class="menu-item-wrapper relative grid gap-8 p-12 ">
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/about-us/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-11.svg"
                                            alt="About Us icon" class="w-8 h-8 mr-2" />
                                        <span class="text-base font-semibold text-brand hover:text-action">About
                                            Us</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/networks/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-12.svg"
                                            alt="Networks icon" class="w-8 h-8 mr-2" />
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Networks</span>
                                    </a>
                                </div>
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/team/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-13.svg"
                                            alt="Team icon" class="w-8 h-8 mr-2" />
                                ...
                                <div class="menu-item relative group ">
                                    <a href="https://uniteus.com/our-careers/"
                                        class="flex -m-3 p-3 menu_click ">
                                        <img src="https://uniteus.com/wp-content/uploads/2025/01/Background-14.svg"
                                            alt="Careers icon" class="w-8 h-8 mr-2" />
                                        <span
                                            class="text-base font-semibold text-brand hover:text-action">Careers</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="pt-5 pb-16 px-5">
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button"
                                ...
                                <img src="https://uniteus.com/wp-content/themes/uniteus-sage/public/images/nav-close.svg"
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                        ...
                                        <div class="overflow-hidden">
                                            <div
                                                ...
                                                <a href="https://uniteus.com/industries/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                        ...
                                        <div class="overflow-hidden">
                                            <div
                                                ...
                                                <a href="https://uniteus.com/industries/community/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Community-Based
                                                        Organizations</span>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                        ...
                                        <div class="overflow-hidden">
                                            <div
                                                ...
                                                <a href="https://uniteus.com/products/closed-loop-referral-system/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Closed-Loop Referral
                                                        System</span>
                                                </a>
                                                <a href="https://uniteus.com/products/social-care-data/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Predictive
                                                        Analytics</span>
                                                </a>
                                                <a href="https://uniteus.com/products/social-care-revenue-cycle-management/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Social Care Revenue
                                                        Cycle Management</span>
                                                </a>
                                                <a href="https://uniteus.com/products/resource-directory/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Resource
                                                        Directory</span>
                                                </a>
                                                <a href="https://uniteus.com/products/care-coordination-services/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Care
                                                        Coordination</span>
                                                </a>
                                                <a href="https://uniteus.com/products/professional-services/"
                                                    class="-m-3 p-3 flex items-start rounded-lg hover:bg-light menu_click ">
                                                    <span class="text-base font-medium text-brand">Managed
                                                        Services</span>
                                                </a>
                                            </div>
                                        </div>
    ...
    <div class="fixed inset-0 z-50 hidden items-center justify-center overflow-auto bg-brand bg-opacity-80"
        ...
        <div class="w-full max-w-4xl sm:p-10 mx-auto" @click.away="showSearchModal = false"
            ...
            <div class="flex items-center justify-end mb-10">
                <button type="button" class="z-10 rounded-full text-white p-1 border border-white cursor-pointer"
            ...
            <div id="site-filters" class="ajax-filters search-filters relative z-20 mb-10">
                <form data-sf-form-id='2207' data-is-rtl='0' data-maintain-state=''
                    ...
                    data-lang-code='en' data-ajax='1' data-ajax-data-type='json'
                    data-ajax-links-selector='.pagination a' data-ajax-target='#search-filter-results-2207'
                    data-ajax-pagination-type='normal' data-update-ajax-url='0' data-only-results-ajax='1'
                    data-scroll-to-pos='window' data-scroll-on-action='pagination' data-init-paged='1'
                    data-auto-update='' action='https://uniteus.com/search-results/' method='post'
                    ...
                    <ul>
                        <li class="sf-field-post_type" data-sf-field-name="_sf_post_type"
                            ...
                            <div class="relative w-full" x-data="Components.popover({ open: false, focus: false })" x-init="init()"
                                @keydown.escape="onEscape" @close-popover-group.window="onClosePopoverGroup"><button
                                    type="button" x-state:on="Item active" x-state:off="Item inactive"
                                    class="group w-full top-10 justify-between inline-flex items-center rounded-md bg-white text-base font-medium focus:outline-none focus:ring-2 focus:ring-action focus:ring-offset-2 text-sm"
                                    :class="{ 'text-brand': open, 'text-brand': !(open) }" @click="toggle"
                                    @mousedown="if (open) $event.preventDefault()" aria-expanded="true"
                                    :aria-expanded="open.toString()">
                                    <span>Search criteria</span><svg width="9" height="14" viewBox="0 0 9 14"
                                ...
                                </button> <!-- UU: AlpineJS drop menu div -->
                                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                    ...
                                    class="absolute filter-drop-menu py-4 inset-x-0 z-10 transform bg-white ring-1 ring-black ring-opacity-5 shadow-lg rounded"
                                    x-ref="panel" @click.away="open = false">
                                    <!-- UU: End AlpineJS drop menu div -->

                                    <ul class="">

                                        <li class="sf-level-0 sf-item-0 sf-option-active" data-sf-depth="0"><input
                                                class="sf-input-radio" type="radio" value=""
                                                name="_sf_post_type[]" checked="checked"
                                                id="sf-input-406675da8e1d9f9ea35db84bb314517c"><label
                                                class="sf-label-radio"
                                                for="sf-input-406675da8e1d9f9ea35db84bb314517c">Search Entire
                                                Site</label></li>
                                        <li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio"
                                                type="radio" value="post" name="_sf_post_type[]"
                                                id="sf-input-e3bb9716e539d03ac0d1939cf5f950c0"><label
                                                class="sf-label-radio"
                                                for="sf-input-e3bb9716e539d03ac0d1939cf5f950c0">Posts</label></li>
                                        <li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio"
                                                type="radio" value="page" name="_sf_post_type[]"
                                                id="sf-input-f28cf570d16f95883225bcf100aba938"><label
                                                class="sf-label-radio"
                                                for="sf-input-f28cf570d16f95883225bcf100aba938">Pages</label></li>
                                        <li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio"
                                                type="radio" value="team" name="_sf_post_type[]"
                                                id="sf-input-459c97b2f45d5929d2978f0e210512a7"><label
                                                class="sf-label-radio"
                                                for="sf-input-459c97b2f45d5929d2978f0e210512a7">Team</label></li>
                                        <li class="sf-level-0 " data-sf-depth="0"><input class="sf-input-radio"
                                                type="radio" value="press" name="_sf_post_type[]"
                                                id="sf-input-a45c1199b9aa907cd30d75cba176ad93"><label
                                                class="sf-label-radio"
                                                for="sf-input-a45c1199b9aa907cd30d75cba176ad93">Press</label></li>
                                    </ul>
                                </div><!-- UU: close AlpineJS div -->
                        </li>
                        <li class="sf-field-search" data-sf-field-name="search" data-sf-field-type="search"
                            data-sf-field-input-type=""> <label>
                                <input placeholder="Search" name="_sf_search[]" class="sf-input-text" type="text"
                                    value="" title=""></label> </li>
                        <li class="sf-field-submit" data-sf-field-name="submit" data-sf-field-type="submit"
                            data-sf-field-input-type=""><input type="submit" name="_sf_submit" value="Submit"></li>
                    </ul>
                </form>
            </div>
        </div>
