  ...
  <div class="component-inner-section relative ">
    <div class="bg-light w-full rounded-2xl flex flex-col md:relative md:flex-none md:grid md:grid-cols-2 lg:gap-20">
      ...
      <div class=" order-2  p-9 md:p-20 flex flex-col  justify-center  text-lg  md:order-1  lg:mb-0">
          ...
          <a href="https://uniteus.com/demo/" class="button  flex items-center gap-3  button-solid" style="text-decoration:none !important;">
            Request Demo
      ...
      <div class="relative pt-0 p-9 md:p-9  pb-0 md:p-0   flex flex-col  justify-center   md:order-2 ">
                  <img class="lazy rounded-lg w-full max-w-sm mx-auto lg:max-w-md entered loaded" data-src="https://uniteus.com/wp-content/uploads/2022/09/building-communities.png" alt="building communities" data-ll-status="loaded" src="https://uniteus.com/wp-content/uploads/2022/09/building-communities.png">
    ...
    <div class="grid grid-cols-4 lg:grid-cols-12 lg:gap-8">
      <div class="col-span-2 mb-16 lg:mb-0">
        <h3 class="text-sm font-semibold text-blue-400 tracking-wider uppercase">Solutions</h3>
                  <div class="menu-footer-solutions-container"><ul id="menu-footer-solutions" class="space-y-4 list-none"><li id="menu-item-357" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-357"><a href="https://uniteus.com/solutions/life-sciences/" class="text-white hover:text-white">For Life Sciences</a></li>
<li id="menu-item-358" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-358"><a href="https://uniteus.com/solutions/providers/" class="text-white hover:text-white">For Providers</a></li>
<li id="menu-item-359" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-359"><a href="https://uniteus.com/solutions/nonprofits/" class="text-white hover:text-white">For Nonprofits</a></li>
<li id="menu-item-360" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-360"><a href="https://uniteus.com/solutions/health-plans/" class="text-white hover:text-white">For Health Plans</a></li>
<li id="menu-item-361" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-361"><a href="https://uniteus.com/solutions/government/" class="text-white hover:text-white">For Government</a></li>
</ul></div>
              </div>

      <div class="col-span-2 mb-16 lg:mb-0">
        <h3 class="text-sm font-semibold text-blue-400 tracking-wider uppercase">Products</h3>
                  <div class="menu-footer-support-container"><ul id="menu-footer-support" class="space-y-4 list-none"><li id="menu-item-363" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-363"><a href="https://uniteus.com/products/t" class="text-white hover:text-white">Products</a></li>
<li id="menu-item-362" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-362"><a href="https://uniteus.com/products/platform/" class="text-white hover:text-white">Platform</a></li>
<li id="menu-item-364" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-364"><a href="https://uniteus.com/products/insights/" class="text-white hover:text-white">Inisghts</a></li>
<li id="menu-item-364" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-364"><a href="https://uniteus.com/products/payments/" class="text-white hover:text-white">Payments</a></li>
<li id="menu-item-364" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-364"><a href="https://uniteus.com/products/care-coordination/" class="text-white hover:text-white">Care Coordination</a></li>
</ul></div>
              </div>
...
<li id="menu-item-2171" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2171"><a href="https://uniteus.com/press/" class="text-white hover:text-white">Press</a></li>
      ...
      <div class="col-span-2 mb-16 lg:mb-0">
        <h3 class="text-sm font-semibold text-blue-400 tracking-wider uppercase">Legal</h3>
                  <div class="menu-footer-legal-container"><ul id="menu-footer-legal" class="space-y-4 list-none"><li id="menu-item-1644" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-1644"><a rel="privacy-policy" href="https://uniteus.com/privacy-policy/" class="text-white hover:text-white">Privacy Policy</a></li>
<li id="menu-item-1645" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1645"><a href="https://uniteus.com/terms-of-service/" class="text-white hover:text-white">Terms of Service</a></li>
</ul></div>
              </div>
    ...
    <div class="border-y border-gray-700 py-10 lg:flex lg:items-center lg:justify-between my-10 lg:my-20 lg:mb-14">
      ...
      <div class="newsletter">
        <iframe src="https://marketing.uniteus.com/l/1001871/2022-12-15/31f9" width="100%" type="text/html" frameborder="0" allowtransparency="true" style="border: 0px; overflow: hidden; height: 46px;" title="Join our Newsletter" id="iFrameResizer0" scrolling="no"></iframe>
      </div>
    </div>
    <div class="md:flex md:items-center md:justify-between">
      <div class="flex space-x-6 md:order-2">
              ...
              <img class="h-5 w-auto" src="https://uniteus.com/wp-content/themes/uniteus-sage/resources/icons/social/facebook.svg?v=1" alt="Facebook">
            </a>

                        <a href="https://www.instagram.com/uniteushq/" target="_blank" class="text-white hover:text-blue-400">
              <span class="sr-only">Instagram</span>
              <img class="h-5 w-auto" src="https://uniteus.com/wp-content/themes/uniteus-sage/resources/icons/social/instagram.svg?v=1" alt="Instagram">
            </a>

                        <a href="https://twitter.com/uniteushq" target="_blank" class="text-white hover:text-blue-400">
              <span class="sr-only">Twitter</span>
              <img class="h-5 w-auto" src="https://uniteus.com/wp-content/themes/uniteus-sage/resources/icons/social/twitter.svg?v=1" alt="Twitter">
            </a>
              ...
              <img class="h-5 w-auto" src="https://uniteus.com/wp-content/themes/uniteus-sage/resources/icons/social/linkedin-modern.svg?v=1" alt="Linkedin Modern">
            </a>
      </div>
