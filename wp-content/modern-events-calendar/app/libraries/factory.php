...
class MEC_factory extends MEC_base
{
    ...
    {
        add_menu_page(__('M.E. Calendar', 'mec'), esc_html__('M.E. Calendar', 'mec'), 'edit_posts', 'mec-intro', array($this->main, 'dashboard'), plugin_dir_url(__FILE__ ) . '../../assets/img/mec.svg', 26);
    }
