...
class MEC_main extends MEC_base
{
    ...
    public function get_sidebar_menu($active_menu = 'settings')
    {
        ...
        $settings = apply_filters('mec-settings-items-settings', array(
            ...
            esc_html__('Assets', 'mec') => 'assets_per_page_option',
            esc_html__('Security Captcha', 'mec') => 'captcha_option',
            esc_html__('Frontend Event Submission', 'mec') => 'fes_option',
            esc_html__('User Profile', 'mec') => 'user_profile_options',
            esc_html__('User Events', 'mec') => 'user_events_options',
            esc_html__('Search', 'mec') => 'search_options',
            esc_html__('Email', 'mec') => 'email_option',
        ), $active_menu);
        ...
        $integrations = apply_filters('mec-settings-items-integrations', array(
            ...
            esc_html__('PaidMembership Pro', 'mec') => 'pmp_options',
        ), $active_menu);
        ...
        $single_event = apply_filters('mec-settings-item-single_event', array(
            ...
            esc_html__('Additional Organizers', 'mec') => 'additional_organizers',
            esc_html__('Additional Locations', 'mec') => 'additional_locations',
            ...
            esc_html__('FAQ', 'mec') => 'single_faq_options',
            esc_html__('Event Banner', 'mec') => 'single_banner_options',
            esc_html__('Trailer URL', 'mec') => 'trailer_url_options',
        ), $active_menu);

        $booking = apply_filters('mec-settings-item-booking', array(
            $this->m('booking', esc_html__('Booking', 'mec')) => 'booking_option',
            sprintf(esc_html__('%s Shortcode', 'mec'), $this->m('booking', esc_html__('Booking', 'mec'))) => 'booking_shortcode',
        ...
        if($this->getPRO())
        {
            ...
            $notifications_items[esc_html__('Notifications Per Event', 'mec')] = 'notifications_per_event';
            $notifications_items[esc_html__('Notification Template', 'mec')] = 'notification_template';
            $single_event[esc_html__('Edit Per Occurrences', 'mec')] = 'per_occurrences';
            $single_event[esc_html__('Only For Bookers', 'mec')] = 'shortcode_only_bookers';
            $modules[esc_html__('Auto Emails', 'mec')] = 'auto_emails_option';
            $modules[esc_html__('Sponsors', 'mec')] = 'sponsors_option';
            $modules[esc_html__('SMS', 'mec')] = 'sms_options';
        }
        ...
        <ul class="wns-be-group-menu">
            ...
            <li class="wns-be-group-menu-li mec-settings-menu <?php echo ($active_menu == 'modules' ? 'active' : ''); ?>">
                <a href="<?php echo esc_url($this->add_qs_var('tab', 'MEC-modules')); ?>" id="" class="wns-be-group-tab-link-a">
                    ...
                    <span class="wns-be-group-menu-title"><?php  esc_html_e('Modules', 'mec'); ?></span>
                </a>
