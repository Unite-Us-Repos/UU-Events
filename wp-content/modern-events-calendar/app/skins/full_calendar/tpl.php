...
<div id="mec_skin_<?php echo esc_attr($this->id); ?>" class="mec-wrap <?php echo esc_attr($event_colorskin . ' '. $label_all_set . ' ' . $set_dark); ?> mec-full-calendar-wrap">
    ...
    <div class="mec-search-form mec-totalcal-box">
        ...
        <div class="mec-full-calendar-search-ends">
            ...
            <div class="mec-search-reset-button"><button class="button mec-button" id="mec_search_form_<?php echo esc_attr($this->id); ?>_reset" type="button"><?php echo esc_html__('Reset', 'mec'); ?></button></div>
            <?php endif; ?>
            <div class="col-md-12 mec-tab-loader">
                <div class="mec-totalcal-view">
                    <?php if($this->yearly): ?><span class="mec-totalcal-yearlyview<?php if($this->default_view == 'yearly') echo ' mec-totalcalview-selected'; ?>" data-skin="yearly"><?php esc_html_e('Yearly', 'mec'); ?></span><?php endif; ?>
                    <?php if($this->monthly): ?><span class="mec-totalcal-monthlyview<?php if($this->default_view == 'monthly') echo ' mec-totalcalview-selected'; ?>" data-skin="monthly"><?php esc_html_e('Monthly', 'mec'); ?></span><?php endif; ?>
                    <?php if($this->weekly): ?><span class="mec-totalcal-weeklyview<?php if($this->default_view == 'weekly') echo ' mec-totalcalview-selected'; ?>" data-skin="weekly"><?php esc_html_e('Weekly', 'mec'); ?></span><?php endif; ?>
                    <?php if($this->daily): ?><span class="mec-totalcal-dailyview<?php if($this->default_view == 'daily') echo ' mec-totalcalview-selected'; ?>" data-skin="daily"><?php esc_html_e('Daily', 'mec'); ?></span><?php endif; ?>
                    <?php if($this->list): ?><span class="mec-totalcal-listview<?php if($this->default_view == 'list') echo ' mec-totalcalview-selected'; ?>" data-skin="list"><?php esc_html_e('List', 'mec'); ?></span><?php endif; ?>
                    <?php if($this->grid): ?><span class="mec-totalcal-gridview<?php if($this->default_view == 'grid') echo ' mec-totalcalview-selected'; ?>" data-skin="grid"><?php esc_html_e('Grid', 'mec'); ?></span><?php endif; ?>
                    <?php if($this->tile): ?><span class="mec-totalcal-tileview<?php if($this->default_view == 'tile') echo ' mec-totalcalview-selected'; ?>" data-skin="tile"><?php esc_html_e('Tile', 'mec'); ?></span><?php endif; ?>
                </div>
            </div>
        </div>
        <?php else: ?>
